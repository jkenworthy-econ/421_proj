...
the largest drop of approximately 4.7 percentage points. Assistant
professors are an exception: their CV rose by roughly 2.4 percentage
...
\midrule
Assistant  & 74.14 & 75.87 & $+2.35$ \\
Associate  & 76.83 & 72.17 & $-4.66$ \\
Full       & 58.91 & 56.80 & $-3.58$ \\
Clinical   & 65.29 & 64.43 & $-1.32$ \\
Research   & 67.83 & 65.70 & $-3.14$ \\
\bottomrule
\end{tabular}
\begin{flushleft}
...
rank-year cell. Source: notebook cell 25.
\end{flushleft}
\end{table}
...
($-4.66$ percentage points), followed by Full Professors ($-3.58$\,pp)
and Research Professors ($-3.14$\,pp). Clinical Professors exhibit a
modest decline of $-1.32$\,pp. Assistant Professors are the notable
exception: their CV increased by $+2.35$\,pp, indicating that relative
...
professors exhibiting the strongest signal ($-4.66$\,pp). This pattern
...
The $+2.35$\,pp increase in the Assistant Professor CV is consistent
...
($-3.6$\,pp), Associate ($-4.7$\,pp), Research ($-3.1$\,pp), and
Clinical ($-1.3$\,pp) professors, indicating a narrowing of relative pay
disparities within these ranks. Assistant Professor CV increased by
$+2.4$\,pp, consistent with external labor-market pressures that prevent
